  ...
  return (
    <section className="py-16 md:py-20">
      <div className="container-x">
        <div
          data-aos="zoom-in"
          className="relative overflow-hidden rounded-[2rem] bg-navy text-navy-foreground px-6 py-12 md:px-14 md:py-16"
        >
          <div className="absolute inset-0 bg-[radial-gradient(50%_70%_at_10%_20%,oklch(0.5_0.22_270/0.45),transparent_60%)]" />
          <div className="absolute -top-10 -right-10 h-60 w-60 rounded-full bg-electric/30 blur-3xl" />
