...
export function Hero() {
  return (
    <section id="home" className="relative pt-28 md:pt-32 pb-16 md:pb-24 overflow-hidden">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(60%_60%_at_50%_0%,rgba(227,30,36,0.10),transparent_60%)]" />
      <div className="absolute -z-10 top-20 -left-20 h-72 w-72 rounded-full bg-brand-red/10 blur-3xl" />
      <div className="absolute -z-10 bottom-0 right-0 h-80 w-80 rounded-full bg-charcoal/10 blur-3xl" />
      ...
      <div className="container-x grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="mt-10 flex items-center gap-6">
            <div className="flex -space-x-3">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="h-10 w-10 rounded-full border-2 border-background bg-gradient-to-br from-brand-red to-brand-dark-red flex items-center justify-center text-xs font-bold text-white"
                >
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="relative aspect-[5/6] sm:aspect-[4/4.5] rounded-[2rem] overflow-hidden shadow-[0_30px_80px_-20px_rgba(17,24,39,0.35)]">
            <div className="absolute inset-0 bg-gradient-to-tr from-charcoal/30 to-transparent z-10" />
            <img
              src={heroImg}
          ...
          >
            ...
            <div>
              <div className="text-sm font-bold text-charcoal">Certified Training</div>
          ...
          >
            <div className="h-10 w-10 rounded-xl bg-charcoal/10 text-charcoal flex items-center justify-center">
              <Users className="h-5 w-5" />
            </div>
            <div>
              <div className="text-sm font-bold text-charcoal">15+ Yrs</div>
